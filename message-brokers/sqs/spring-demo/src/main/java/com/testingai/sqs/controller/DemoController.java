...
public class DemoController {
	...
	public ResponseEntity<String> retry(@RequestParam String message, @RequestParam(defaultValue = "1") int count) {
		for (int i = 0; i < count; i++) {
	...
	public ResponseEntity<String> fifo(@RequestParam String message,
