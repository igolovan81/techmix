...
@Slf4j
public class WorkQueueConsumer implements StreamListener<String, MapRecord<String, String, String>> {
	...
	public void registerWith(StreamMessageListenerContainer<String, MapRecord<String, String, String>> container) {
		container.receive(Consumer.from("work-group", "worker-1"),
				StreamOffset.create(StreamKeys.WORK, ReadOffset.lastConsumed()), this);
		container.receive(Consumer.from("work-group", "worker-2"),
				StreamOffset.create(StreamKeys.WORK, ReadOffset.lastConsumed()), this);
	}
	...
	public void onMessage(MapRecord<String, String, String> record) {
		try {
			...
			redisTemplate.opsForStream().acknowledge(StreamKeys.WORK, "work-group", record.getId());
