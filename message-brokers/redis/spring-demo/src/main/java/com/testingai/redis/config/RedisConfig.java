...
public class RedisConfig {
	...
	public StreamMessageListenerContainer<String, MapRecord<String, String, String>> streamListenerContainer() {
		var options = StreamMessageListenerContainerOptions.builder().pollTimeout(Duration.ofMillis(100))
	...
	@Bean
	public WorkQueueConsumer workQueueConsumer(RedisTemplate<String, String> redisTemplate,
			StreamMessageListenerContainer<String, MapRecord<String, String, String>> container) {
	...
	@Bean
	public PendingConsumer pendingConsumer(RedisTemplate<String, String> redisTemplate,
			StreamMessageListenerContainer<String, MapRecord<String, String, String>> container) {
	...
	@Bean
	public TrimmingConsumer trimmingConsumer(RedisTemplate<String, String> redisTemplate,
			StreamMessageListenerContainer<String, MapRecord<String, String, String>> container) {
	...
	@Bean
	public RedisMessageListenerContainer pubSubListenerContainer(PubSubSubscriberA subscriberA,
	...
	public void createConsumerGroups() {
		List<String[]> streamGroups = List.of(new String[]{StreamKeys.WORK, "work-group"},
				new String[]{StreamKeys.FANOUT, "group-a"}, new String[]{StreamKeys.FANOUT, "group-b"},
				new String[]{StreamKeys.PENDING, "pending-group"}, new String[]{StreamKeys.TRIMMED, "trimmed-group"});
		for (String[] sg : streamGroups) {
			String stream = sg[0];
			String group = sg[1];
			try {
				redisTemplate.opsForStream().createGroup(stream, ReadOffset.from("$"), group);
